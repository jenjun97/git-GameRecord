...
import com.GameRecord.sample.dto.AddScorePojo;
import com.GameRecord.sample.dto.request.AddPlayerRequestDto;
import com.GameRecord.sample.dto.request.AddScoreRequestDto;
...
import com.GameRecord.sample.dto.response.ScoreboardResponseDto;
import com.GameRecord.utils.MyDateTimeUtil;
import com.GameRecord.utils.MySourceUtil;
...
public class SampleService {
	...
	public boolean validPlayerNum(int playerNum) {
		int big2PlayerMax = Integer.parseInt(MySourceUtil.get("big2.player.max"));
	...
	public List<HisDeskResponseDto> queryHisDesk() {
		String kindStr = MySourceUtil.get("kind.big2");
	...
	private int addDesk(String deskUuid, AddPlayerRequestDto requestDto) {
		int deskId = big2Dao.addDesk(deskUuid, requestDto.getDeskName(), MySourceUtil.get("kind.big2"),
